...
description: "Configure the Django backend and React Native frontend using environment variables. Reference for all required and optional settings with example values."
---
