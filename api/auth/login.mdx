---
title: "POST /api/user/token/ — Obtain JWT Access Token"
sidebarTitle: "Login"
description: "Exchange a username and password for a JWT access token (15 min) and refresh token (30 days). Use the access token as a Bearer token on all protected endpoints."
---
