...
description: "Zero out all three preference vectors on the user's profile. Recommendations revert to generic results until new preferences are set via Set Preferences."
---
