...
<ParamField body="preferences" type="integer[]" required>
  ...
  <Expandable title="Preference array positions">
    Each index in the array maps to one UK attraction general type group. Pass `1` to indicate interest and `0` to opt out:

    | Index | Category group |
    | --- | --- |
    | 0 | Animals |
    | 1 | Architecture / Landmark |
    | 2 | Entertainment |
    | 3 | History & Culture |
    | 4 | Natural |
    | 5 | Sea |
